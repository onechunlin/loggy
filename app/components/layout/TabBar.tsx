...
export default function TabBar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-0 right-0 h-16 sm:h-20 bg-white border-t border-gray-100 flex items-center justify-around px-2 sm:px-4 z-50 shadow-lg"
    >
      {navItems.map((item) => {
        ...
        return (
          <motion.button
            ...
            className={`
              relative flex-1 max-w-[120px] h-full flex flex-col items-center justify-center gap-1
